...
$query9 = "SELECT * FROM bs_supplylogs WHERE DateSupplied = '$suptoday' ORDER BY Timestamp DESC";  
...
$reqfood = $row9['ReqFood'];
$reqweapons = $row9['ReqWeapons'];
...
//inserts the data in rows, creating one row for every record found
  ...
  echo "<td align='center' style='padding-left:20px; padding-right:20px; font-weight:normal; padding-top:4px; padding-bottom:5px; color:#1A6600;'>" . $reqfood . "</td>";
  echo "<td align='center' style='padding-left:20px; padding-right:20px; font-weight:normal; padding-top:4px; padding-bottom:5px; color:#B20000;'>" . $reqweapons . "</td>";
