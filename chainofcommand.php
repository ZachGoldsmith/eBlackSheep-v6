...
<title>VMA-214 | BlackSheep Military Unit | Chain of Command | eRepublik</title>
...
#commandercontent, #honorguardcontent {
	width:270px;
	height:auto;
	margin:0 auto;
	margin-top:5px;
...
<div id="content">
<div id="commander">
COMMANDER OF VMA-214
</div>
<div id="commandercontent">
<table width="100%" border="0">
  <tr>
    <td align="center"><img src="<?=$commandavatar?>" width="50" height="50" style="border:#000000 1px solid" /></td>
    <td align="left"><a href="<?=$commanderlink?>" target="_blank"><?=$commandname?></a></td>
  </tr>
</table>
</div>
...
<div id="honorguardcontent" align="center">
<?php
$sql5 = "SELECT * FROM bs_accounts WHERE Team = 'HG' && CitizenName != '$commandname'";
...
$hgname = $row5['CitizenName'];
$hgavatar = $row5['Avatar'];
$hglink = 'http://www.erepublik.com/en/citizen/profile/'.$row5['CitizenID'];

if($i % $col == 0) {
echo '</tr><tr>';	
}
echo '<td align="center"><img src="'.$hgavatar.'" width="20" height="20" style="border:#000000 1px solid" /></td>';
echo '<td align="center"><a href="'.$hglink.'" target="_blank">'.$hgname.'</a></td>';  
}
echo '</tr>'; 
echo '</table>';
?>
