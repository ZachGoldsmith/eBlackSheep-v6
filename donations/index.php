...
<title>VMA-214 | BlackSheep Military Unit | Donations | eRepublik</title>
...
<table width="800" border="0">
  <tr>
    <td align="left"><img src="../images/logos/logo3.png" width="159" height="61" /></td>
...
<table width="800px" border="0" style="margin: 0 auto;" align="center">
  <tr>
    ...
    <td align="right" style="color:#666666;font-family:BerlinSans,'Berlin Sans FB';font-size:10px;">Version: <?=$version?> | Created and Managed by: Zach Goldsmith</td>
  </tr>
</table>
<div id="line1"></div>
</div>
