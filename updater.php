...
<title>VMA-214 | BlackSheep Military Unit | Manual API Updater | eRepublik</title>
...
$(function() {
  $("#accordion, #accordion2, #accordion3, #accordion4, #accordion5").accordion({
    ...
    $( "#updater-button, #stopupdater-button" ).button()
});
</script>
</head>
...
<div id="content">
CLICK START BUTTON TO BEGIN UPDATING MU
<br />
<span style="color:#B20000">DO NOT CLOSE THIS WINDOW WHILE UPDATING</span>
<br />
<br />
<script type="text/javascript">
$(function(){
    $('#updater-button').click(function(){
        if(!$('#updater').length) {
                $('#updaterholder').html('<iframe id="updater" src="http://bsdev.zapto.org/v5/update/update-mu.php" width="100%" height="250" frameborder="0"></iframe>');
        }
    });   
});
</script>

<input id="updater-button" type="button" value="Start Updating" /> <input id="stopupdater-button" onclick="window.stop();" type="button" value="Stop" />
<br />
<br />
<div id="updaterholder" align="center" style="font-size:12px;font-family:"Berlin Sans FB", BerlinSans;"></div>
