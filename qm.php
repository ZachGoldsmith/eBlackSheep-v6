...
<title>VMA-214 | BlackSheep Military Unit | QM | eRepublik</title>
...
<h3>Supply Requests</h3>
  <div>
    <p>
	<?php include('todaysupply.php'); ?> 
	<div id="accordion2" style="margin-top:10px;">
	<h3>Today's Supply Logs</h3>
  	<div>
    <p>
	<?php include('todaysupplylogs.php'); ?>    
	</p>     
  </div>
  </div>       
	</p>     
...
<h3>Gold Requests</h3>
  <div>
    <p>
	<?php include('todaygold.php'); ?> 
	<div id="accordion3" style="margin-top:10px;">
	<h3>Today's Gold Logs</h3>
  	<div>
    <p>
	<?php include('todaygoldlogs.php'); ?>    
	</p>     
  </div>
  </div>       
	</p>     
